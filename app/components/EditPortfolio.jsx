    ...
    <div className="container">
      <div className="my-10">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
          <label htmlFor="playground" className="peer-checked/playground:text-sky-500 bg-zinc-50 rounded-lg border border-zinc-100 flex justify-between p-4 h-32">
            ...
            <div className="flex items-start span justify-center relative">
              <input id="playground" className="peer/playground checked:bg-blue-500" type="radio" name="status" />
            </div>
