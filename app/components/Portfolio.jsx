    ...
    <>
      ...
      <div className="my-10">
        <div className="grid-rows-1 mb-6 flex justify-between items-center">
          ...
          <Link href="/settings/profile" className="font-semibold text-indigo-600 text-sm md:text-base"><span>Create new project</span></Link>
        </div>
        <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
      ...
      <div className="my-10">
        <div className="grid-rows-1 mb-6 flex justify-between items-center">
          ...
          <Link href="/settings/socials" className="font-semibold text-indigo-600 text-sm md:text-base"><span>Create new playground</span></Link>
        </div>
        <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
